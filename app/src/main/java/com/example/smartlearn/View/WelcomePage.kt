    ...
    Column(
       ...
       Row (
        ...
        Column( modifier = modifier.fillMaxSize(),
            ...
            {
                Text(text = WelcomePageMsg.msg!!,modifier = Modifier.padding(0.dp,0.dp,0.dp,20.dp).background(color = Color.Green ,shape = RoundedCornerShape(8.dp)).padding(30.dp,10.dp,20.dp,10.dp), color = Color.White)
